...
from stargaze_ml.gold.l2_dominance_model import DominanceModelConfig, train_dominance_model
...
def main() -> None:
    ...
    report = train_dominance_model(
        args.prepared, args.open_checkpoint, args.risk_checkpoint,
        args.rate_report, args.out_dir, DominanceModelConfig(),
